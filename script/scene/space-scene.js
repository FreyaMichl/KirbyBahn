  ...
  afterTick() {
    ...
    if (keyIsDown(32)) {
      ...
      if (Matter.SAT.collides(this.planet2.sprite.body, body).collided) {
        Body.applyForce(body, body.position, Vector.mult(Vector.normalise(Vector.sub(Vector.add(this.spaceshipLeft.sprite.body.position, Vector.create(300, 0)), body.position)), 0.01))
      }
    }

...
export default class Tomato extends Entity {
    ...
    preload() {
        this.eatingSound = loadSound("assets/audio/eating.mp3")
    }
    ...
    afterTick() {
        ...
        if (Matter.SAT.collides(environment.scene.kirby.sprite.body, this.sprite.body).collided && !this.eaten) {
            this.sprite.body.collisionFilter = {
                group: false
            }
